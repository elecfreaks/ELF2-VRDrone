...
#define PIOS_USB_BOARD_PRODUCT_ID      USB_PRODUCT_ID_COPTERCONTROL//USB_PRODUCT_ID_ELFVRDRONE//
#define PIOS_USB_BOARD_DEVICE_VER      USB_OP_DEVICE_VER(USB_PRODUCT_ID_ELFVRDRONE, USB_OP_BOARD_MODE_FW)
