...
//#define PIOS_INCLUDE_ESP8266
#if defined(PIOS_INCLUDE_MS5611_SPI) || defined(PIOS_INCLUDE_MS5611) || defined(PIOS_INCLUDE_FBM320_I2C) || defined(PIOS_INCLUDE_CPS122)
