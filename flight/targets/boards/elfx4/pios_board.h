...
/* Add by Richile */
extern uint32_t pios_com_uart_rcvr_id;
#define PIOS_COM_UART_RCVR    (pios_com_uart_rcvr_id)
...
#define PIOS_ADC_PIN1_GPIO_PORT          GPIOB                   // PB0 (Battery)
